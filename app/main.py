...
# web_replica_engine handles redirects + stats and web_engine handles
# writes only; sync_engine runs one connection every 30s
web_engine = make_engine(DATABASE_URL, pool_size=25, max_overflow=5)
web_replica_engine = make_engine(
    READ_REPLICA_URL, pool_size=25, max_overflow=5
)
